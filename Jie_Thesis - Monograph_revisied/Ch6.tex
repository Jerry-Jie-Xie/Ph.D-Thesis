...
\\
In Chapters \ref{cha:cha4EnhancedFeature} and \ref{cha:cha5WaveletFeature}, all the recordings are assumed to have only one frog species per recording. While most collected environmental recordings often have multiple frog species per recording.

\\
\textbf{Research sub-question}
\\
How to classify multiple frog species in low SNR recordings?
