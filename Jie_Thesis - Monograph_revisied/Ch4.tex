...
\chapter[Frog call classification based on enhanced features]{Frog call classification based on fused features and machine learning algorithms}
...
\begin{table}[h]
\centering
\caption{Comparision with previous used feature sets}
\label{my-label}
\resizebox{\textwidth}{!}{
\begin{tabular}{lll}
\hline\hline
