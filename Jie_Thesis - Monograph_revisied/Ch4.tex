...
As we know, the window size has an effect on the MFCCs and perceptual features. Therefore, a different window size will lead to different classification performance (Figure~\ref{diffWinSize1} and Figure~\ref{diffWinSize2}). The window size used for the test is 32, 64, 128, 256, because the syllable length of some frog species is less than 512 samples.
