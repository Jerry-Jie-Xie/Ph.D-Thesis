...
\item  Most environmental recordings contain multiple frog species in an individual recording, which is different from recordings used in previous studies (one species per recording). The classification framework used for classifying frog species in environmental recordings must be able to predict multiple labels for one individual recording.
...
\item Chapter \ref{cha:cha8Application} applied the ML classification for the long-term monitoring of frog calling activity and species richness.
