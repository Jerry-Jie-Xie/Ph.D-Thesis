...
Figure~\ref{ch2:fig:flowchart} depicts the system structure of frog call classification, which includes pre-processing, feature extraction, and classification. 
