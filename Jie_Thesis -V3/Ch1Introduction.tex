...
Bufo marinus                &   \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=30mm]{image/toad_jcu_wav.png}  \end{minipage}       &      \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=30mm]{image/toad_jcu_spec.png}  \end{minipage}       & 1.86     \\ \hline
Cyclorana novaehollandiae   &  \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=30mm]{image/cyc_jcu_wav.png}  \end{minipage}        & \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=30mm]{image/cyc_jcu_spec.png}  \end{minipage}            & -0.13    \\ \hline
...
Bufo marinus                &  \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/1_signal.png}  \end{minipage}       &      \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/1_noise.png}  \end{minipage}          \\ \hline
\begin{tabular}[c]{@{}l@{}} Cyclorana \\ novaehollandiae  \end{tabular}    & \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/2_signal.png}  \end{minipage}                              &                                              \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/2_noise.png}  \end{minipage}   \\ \hline
 \begin{tabular}[c]{@{}l@{}} Limnodynastes \\ terraereginae  \end{tabular}  &  \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/3_signal.png}  \end{minipage}                              &                                             \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/3_noise.png}  \end{minipage}   \\ \hline
...
\begin{tabular}{lll}
\hline
Litoria rothii              &  \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/6_signal.png}  \end{minipage}                         &    \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/6_noise.png}  \end{minipage}                                           \\ \hline
Litoria rubella             &    \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/7_signal.png}  \end{minipage}                               &                                               \begin{minipage}{.3\textwidth} \includegraphics[width=45mm, height=35mm]{image/7_noise.png}  \end{minipage} \\ \hline
